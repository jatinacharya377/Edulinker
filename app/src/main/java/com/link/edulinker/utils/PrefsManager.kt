...
import com.link.edulinker.EduLinkerApplication

object PrefsManager {
    const val USER_TOKEN = "user_auth_token"
    private const val PREF_NAME = "open_in_app_pref"
    private val preference: SharedPreferences = EduLinkerApplication.INSTANCE.getSharedPreferences(PREF_NAME, Context.MODE_PRIVATE)
